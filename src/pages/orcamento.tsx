...
const Orcamento = () => {
  ...
  useEffect(() => {
    ...
    void redirectToWhatsApp({ placement: `redirect_orcamento` });
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://nncacambas.com.br/orcamento" />
        ...
        <meta property="twitter:url" content="https://nncacambas.com.br/orcamento" />
